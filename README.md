...
| Item | Valor |
|------|--------|
| Jogo | The Forgotten City |
| Versão | **1.3.0** |
| Engine | Unreal Engine **4.26** |
| Plataforma | Steam |

Outras versões ainda não foram testadas.
...
Todos os direitos sobre o jogo pertencem aos seus respectivos desenvolvedores e publicadores.
